...
var ThinkingDataAPI = /*#__PURE__*/function () {
  ...
  _createClass(ThinkingDataAPI, [{
    ...
    value: function _isReady() {
      // console.log("======>>>>>>>>:_state.getSystemInfo " + this._state.getSystemInfo)
      // console.log("======>>>>>>>>:_state.initComplete " + this._state.initComplete)
      // console.log("======>>>>>>>>:store.initComplete " + this.store.initComplete)
